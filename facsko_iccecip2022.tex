...
\end{tabular}
\caption[Forecast organisations. ]{Space weather prediction centres all over the world: from US to China and from Brazil to Finland.}
\label{tab:agencies}
\end{table}
